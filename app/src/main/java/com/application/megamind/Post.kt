...
class Post (val id_post: String?, val id_profil: String, val contenu_post:String, val sensibilite_post:String, val createdAt:Timestamp,val updatedAt:Timestamp){
